 ...
 * to {@link DragSortExListView#setAdapter(ListAdapter)} and, since
 * this class implements the {@link DragSortExListView.DragSortListener}
 * interface, it is automatically set as the DragSortListener for
 * the DragSortListView instance.
 */
public abstract class DragSortCursorAdapter extends CursorAdapter implements DragSortExListView.DragSortListener {
     ...
     *
     * @see DragSortExListView.DropListener#drop(int, int)
     */
    @Override
     ...
     * the current mapping with {@link getCursorPositions()}.
     *
     * @see DragSortExListView.RemoveListener#remove(int)
     */
    @Override
