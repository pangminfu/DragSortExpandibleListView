...
/**
 * Class that starts and stops item drags on a {@link DragSortExListView}
 ...
 * {@link DragSortExListView#setTouchListener()} and
 * {@link DragSortExListView#setFloatViewManager()} of your
 * {@link DragSortExListView} instance.
 */
public class DragSortController extends SimpleFloatViewManager implements View.OnTouchListener, GestureDetector.OnGestureListener {
    ...
    private DragSortExListView mDslv;
    private int mPositionX;

    /**
     * Calls {@link #DragSortController(DragSortExListView, int)} with a
     ...
     */
    public DragSortController(DragSortExListView dslv) {
        this(dslv, 0, ON_DOWN, FLING_REMOVE);
    }

    public DragSortController(DragSortExListView dslv, int dragHandleId, int dragInitMode, int removeMode) {
        this(dslv, dragHandleId, dragInitMode, removeMode, 0);
    }

    public DragSortController(DragSortExListView dslv, int dragHandleId, int dragInitMode, int removeMode, int clickRemoveId) {
     ...
     */
    public DragSortController(DragSortExListView dslv, int dragHandleId, int dragInitMode,
    ...
    public boolean startDrag(int position, int deltaX, int deltaY) {
        ...
        int dragFlags = 0;
        for (int i=0; i<mDslv.getAdapter().getCount(); i++)
            mDslv.collapseGroup(i);
        if (mSortEnabled && !mIsRemoving) {
            dragFlags |= DragSortExListView.DRAG_POS_Y | DragSortExListView.DRAG_NEG_Y;
        }
        if (mRemoveEnabled && mIsRemoving) {
            dragFlags |= DragSortExListView.DRAG_POS_X;
            dragFlags |= DragSortExListView.DRAG_NEG_X;
        }
